...
public class Fragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button buttonToNext=view.findViewById((R.id.btnF21));
        //Configurar la accion del boton
        buttonToNext.setOnClickListener(v -> {
            NavController navController= Navigation.findNavController(view);
            navController.popBackStack();
            //Backstack: etructura de datos(pila) que guarda las vistas anteriores(back)
        });

        Button buttonToNext2=view.findViewById((R.id.btnF22));
        //Configurar la accion del boton
